...
- **Sessions.** Favourite a session to the sidebar, fork it to branch the conversation, search across projects via the Session Browser (sidebar icon), or ask the agent with `/ss` to find a past session by what it was about.
