  ...
  en: {
    ...
    modes: {
      ...
      workflow: {
        ...
        desc: 'Start several lines with / or /@ and OpenCockpit reads them as one workflow — the AI decides order and parallelism after seeing the whole message.',
  ...
  zh: {
    ...
    modes: {
      ...
      workflow: {
        tag: '新 · 串起来',
        headline: '把命令叠成一条工作流',
        desc: '让多行分别以 / 或 /@ 开头，OpenCockpit 就把它们作为一条工作流交给 AI；AI 读完整条消息后自行决定顺序与并行。',
        mainText: '这步在主会话执行',
        subText: '这步委派给子代理',
        example: '/fx\n查清楚为什么重试会重复扣款\n/@cr\n审一下这个修复有没有竞态',
        link: '工作流怎么用 →',
